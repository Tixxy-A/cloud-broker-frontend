...
import { HIDE_ALERT, SETUP_USER_BEGIN, SETUP_USER_ERROR, SETUP_USER_SUCCESS } from "./actions.js";
...
export const AppProvider = ({children}) => {
    ...
    const setUpUser =  async ({currentUser, endpoint, alertText}) => {
        ...
        try{
            ...
            const response = await axios.post(`http://localhost:5000/api/v1/auth/${endpoint}`,currentUser);
